export class ImageClass 
{
    ...
    constructor(link : string , caption: string)
    {
        this.Url = link;
...
class Operation
{
    ...
    captionTag : HTMLElement;
    imageList: any[];

    constructor(index : number,imgTag : HTMLImageElement, captionTag : HTMLElement,imageList : any[])
    {
...
let index : number = 0;
let imageTag : HTMLImageElement = document.getElementById("image-box") as HTMLImageElement;
let captionTag : HTMLElement = document.getElementById("caption-tag") as HTMLElement; 
